...
namespace CoursesList
{
  ...
  public sealed partial class MainPage : Page
  {
    ...
    private A2MicroThermalPrinter _imprimante = null;
    ...
    private async void Page_Loaded(object sender, RoutedEventArgs e)
    {
      ...
      _imprimante = new A2MicroThermalPrinter(parametresImprimante, true, 0);
    ...
    private void ImprimanteAPB_Click(object sender, RoutedEventArgs e)
    {
      ListeProduits.instance.ImprimerListe(_imprimante);
    }
