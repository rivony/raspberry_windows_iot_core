...
namespace DoMesCenterLIB
{
  public class SensorTagCC2650VM : VMBase
  {
    ...
    private async void _modele_SurNiveauBatterie_NouvelleValeur(byte? nouvelleValeur)
    {
      if (nouvelleValeur != null)
      {
        NiveauBatterie = nouvelleValeur;
        await _dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
        {
          OnPropertyChanged("NiveauBatterie");
        });
      }
      Batterie_DerniereLectureReussie = (nouvelleValeur != null);
      await _dispatcher.RunAsync(CoreDispatcherPriority.Normal, () =>
      {
        OnPropertyChanged("Batterie_DerniereLectureReussie");
      });
    }
    ...
    public byte? NiveauBatterie                 { get; private set; }
    public bool Batterie_DerniereLectureReussie { get; private set; }
    ...
    public SensorTagCC2650VM(SensorTagCC2650 modele)
    {
      ...
      NiveauBatterie = null;
      Batterie_DerniereLectureReussie = false;
      _modele.SurNiveauBatterie_NouvelleValeur += _modele_SurNiveauBatterie_NouvelleValeur;
    }
  }
}
